                ...
                <tr>
                    ...
                    <td>
                        <p style="text-align: right;">
                            <a href="${process.env.APP_URL}" target="_blank" style="text-decoration: none;">View In Website</a>
                        </p>
                    </td>
                </tr>
            </table>
    ...
    <tr>
        <td>
            <table border="0" cellpadding="0" cellspacing="0" style="text-align:center;width:100%;background-color:#fff;">
                ...
                <tr>
                    <td>
                        <p style="padding:0px 60px; color:#000;">
                            You’ve been <b>mentioned</b> in a post by <b>${mentionedBy}</b>.
                        </p>
                        <p style="margin:20px 0;">
                            <a href="${postLink}" target="_blank" 
                                style="background-color:#630E2B;color:#fff;padding:10px 20px;border-radius:4px;text-decoration:none;">
                                View Post
                            </a>
                        </p>
                    </td>
